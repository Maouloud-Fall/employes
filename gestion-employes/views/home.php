...
<div class="container">
	<div class="row my-4">
		<div class="col-md-10 mx-auto">
			...
			<div class="card">
				<marquee behavior="" direction="">Liste des employés de Team_Fall</marquee>
					    ...
					    <?php foreach($employes as $employe):?>
					    	<tr>
						      ...
						      <td class="d-flex flex-row">
								...
								<form method="post" class="mr-1" action="messages">
									<a href="messages.php?employee_id=<?php echo $employe['id']; ?>" class="btn btn-sm btn-primary mr-1">
