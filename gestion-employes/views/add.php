...
// Déclaration de la variable $matricule
$matricule = 'Team_Fall-' . date('Ymd') . '-' . mt_rand(1000, 9999);
				...
				<div class="card-body bg-light">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="text" name="mat" class="form-control" placeholder="Matricule" value="<?php echo $matricule; ?>" readonly>
						</div>
